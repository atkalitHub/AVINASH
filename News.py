news_text = """
        ...
        Please take a moment to review the following important announcements:

        This is a cutting-edge application designed for the Ticket Data Proxy/IP menu.
        Ensure seamless operations by utilizing your registered User ID for all activities.
        Our team is relentlessly innovating to bring you frequent updates and enhanced functionalities.
